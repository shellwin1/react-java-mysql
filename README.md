...
### React application with a Spring backend and a MySQL database with PHPAdmin
...
Build applications and push to container registry
...
### kubectl
```
$ az account set --subscription 9cc49b3e-956b-41dd-a6de-9c40472cc9da
$ az aks get-credentials --resource-group pih-pol-dev-rg-001 --name pih-pol-dev-aks-001 --overwrite-existing
